    ...
    return (
        <section className="my-[40px]">
            <div className="max-w-[364px] mx-auto">
                <h1 className="font-[AsgardBold] text-[36px] leading-9 text-[#343434] font-normal mb-[40px] -tracking-[.02em]">Расписание встреч</h1>
                <div className="bg-[#343434] rounded-[8px] px-[28px] py-[32px]">
                    ...
                    <ul className="flex flex-col items-center">
                        <li className="p-[16px] bg-[#F4B8A9] relative flex flex-col items-center w-[100%] mt-[30px] rounded-[4px] overflow-hidden">
                            ...
                            <div className="relative z-[2] w-[100%]">
                                <ul className="text-end w-[100%] mb-[16px]">
