        ...
        <section className="flex flex-col  pt-[80px] px-[32px] items-center">
            ...
            <ul className="flex flex-col items-center">
                <li className="mt-[40px] flex flex-col items-center relative">
                    ...
                    <div>
                        <h3 className="bg-[#343434] font-[AsgardBold] w-[364px] h-[96px] mt-[32px] rounded-[8px] text-center pt-[12px] text-[32px] leading-8 text-white">Екатерина
                            Быстрова</h3>
                ...
                <li className="mt-[40px] flex flex-col items-center">
                    <img src={photo2} className="rounded-[50%]"/>
                    <div>
                        <h3 className="bg-[#343434] font-[AsgardBold] w-[364px] h-[96px] mt-[32px] rounded-[8px] text-center pt-[12px] text-[32px] leading-8 text-white">Мария Домбровская</h3>
                        <p className="mt-[16px] text-center font-[Montserrat] text-[16px] leading-[25px] ">Южный федеральный университет,
                            <br/>
                            Ростов-на-Дону
                            <br/>
                ...
                <li className="mt-[40px] flex flex-col items-center relative">
                    ...
                    <img src={star} className="absolute left-[90px] top-[3px]"/>
                    <div>
                        <h3 className="bg-[#343434] font-[AsgardBold] w-[364px] h-[60px] mt-[32px] rounded-[8px] text-center pt-[12px] text-[32px] leading-8 text-white">Ольга Жукова</h3>
                        <p className="mt-[16px] text-center font-[Montserrat] text-[16px] leading-[25px] ">Южный федеральный университет,
                            <br/>
                            Ростов-на-Дону
                            <br/>
                ...
                <li className="mt-[40px] flex flex-col items-center">
                    <img src={photo4} className="rounded-[50%]"/>
                    <div>
                        <h3 className="bg-[#343434] font-[AsgardBold] w-[364px] h-[96px] mt-[32px] rounded-[8px] text-center pt-[12px] text-[32px] leading-8 text-white">Елена Давлетшина</h3>
