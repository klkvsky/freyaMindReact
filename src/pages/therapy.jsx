  ...
  return (
    <div className="w-screen overflow-hidden">
      ...
      <main>
        ...
        <div className="flex flex-row w-full items-center justify-center mt-[58vh] gap-[15px]">
          <img
          ...
          <img
            ...
            className="h-[51px] aspect-square"
          />
          <img
        ...
        <h1 className="text-[18px] font-bold text-center mt-[30px]">
          Вы не можете установить цену на психическое здоровье, но наши цены
          дают вам душевное спокойствие
        </h1>

        <p className="text-[14px] font-light text-center w-4/6 mx-auto mt-[95px]">
          Встречи с психологом легко впишутся в ваш привычный график!
        </p>
        <p className="text-[14px] font-light text-center w-4/6 mx-auto mt-[25px] mb-[105px]">
        ...
        <div className="flex flex-col bg-[#5d6541] min-h-screen text-white py-[110px]">
          <h1 className="text-[25px] font-semibold text-center uppercase">
            Планы терапии
          </h1>

          <div className="flex flex-col border-[1px] border-white bg-[#b7b77f] shadow-md w-[311px] mx-auto rounded-[15px] px-[15px] pt-[25px] pb-[20px] mt-[65px]">
            ...
            <div className="flex flex-row items-center justify-start border-[1px] border-white rounded-full w-full mt-[30px] pl-[12px] relative">
              ...
              <h2 className="text-[40px] font-semibold text-[#858585]">€78</h2>
            ...
            <p className="text-[12px] text-black mt-[10px]">
              **по промокоду “FRESHSTART” вы получите первые две сессии по цене
              одной.
            </p>
          </div>

          <div className="flex flex-col border-[1px] border-white bg-[#edaf71] shadow-md w-[311px] mx-auto rounded-[15px] px-[15px] pt-[25px] pb-[20px] mt-[45px]">
            <h1 className="text-[22px] font-semibold leading-7">
              РЕГУЛЯРНЫЕ СЕССИИ
            </h1>
            ...
            <p className="text-white font-semibold text-[16px] mt-[40px]">
              кому нужны регулярные встречи с психологом, чтобы решить волнующие
              проблемы, поднять качество жизни и прийти к гармонии с собой.
            </p>
          ...
          <div className="flex flex-col border-[1px] border-white bg-[#818a62] shadow-md w-[311px] mx-auto rounded-[15px] px-[15px] pt-[25px] pb-[20px] mt-[45px]">
            <h1 className="text-[22px] font-semibold leading-7">
          ...
          <p className="text-[14px] font-light w-[310px] mx-auto mt-[40px]">
        ...
        <div className="px-[55px] pt-[95px]">
          ...
          <img
            ...
            className="w-[266px] mx-auto mt-6"
          />
        </div>
